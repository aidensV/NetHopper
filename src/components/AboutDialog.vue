    ...
    <Teleport to="body">
        <Transition name="about">
            <div v-if="open" class="fixed inset-0 z-[70] grid place-items-center bg-black/75 p-5 backdrop-blur-md"
                ...
                <section
                    class="surface relative w-full max-w-lg overflow-hidden rounded-2xl shadow-[0_30px_90px_rgba(0,0,0,.55)]">
                    <div
                    ...
                    <div class="px-7 pb-6 pt-8 text-center">
                        <div
                            class="mx-auto grid size-14 place-items-center rounded-2xl bg-cyan-400 text-slate-950 shadow-[0_0_35px_rgba(34,211,238,.22)]">
                        ...
                        <span
                            class="mt-3 inline-flex rounded-full border border-cyan-400/15 bg-cyan-400/8 px-3 py-1 text-[11px] font-semibold text-cyan-300">
                            Version {{ version }}
                        </span>
                    </div>
                    ...
                    <div class="border-y border-white/6 bg-black/10 px-7 py-5">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div v-for="technology in technologies" :key="technology.name"
                                ...
                                <div
                                    class="grid size-8 shrink-0 place-items-center rounded-lg bg-white/5 text-cyan-300">
                    ...
                    <div class="grid grid-cols-3 gap-3 px-7 py-5 text-center">
                        <div>
                            <TerminalSquare :size="15" class="mx-auto text-slate-500" />
                            <p class="mt-1.5 text-[10px] text-slate-500">SSH terminal</p>
                        </div>
                        <div>
                            <KeyRound :size="15" class="mx-auto text-slate-500" />
                            <p class="mt-1.5 text-[10px] text-slate-500">Encrypted vault</p>
                        </div>
                        <div>
                    ...
                    <footer
                        class="flex items-center justify-between border-t border-white/6 px-7 py-4 text-[10px] text-slate-600">
                        <span>Data stays on your device</span>
                        <span class="flex items-center gap-1.5">
                            <Github :size="12" /> NetHopper Desktop
                        </span>
                    </footer>
                </section>
            </div>
